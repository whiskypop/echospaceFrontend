Page({
  data: {
    imageUrl: 'cloud://cloud1-5gmggv5l8f2ead23.636c-cloud1-5gmggv5l8f2ead23-1326484866/backgroundImage/share.jpg', // 默认图片URL
    audioInfo: [
      {
  ...
  onLoad: function(options) {
    if (options.imageUrl) {
      this.setData({ imageUrl: decodeURIComponent(options.imageUrl) });
    }
  },
